...
const ChangePasswordPage = () => {
	return (
		<div className="flex flex-col mx-auto flex-1 w-full bg-white sm:bg-green-100 md:flex-row sm:justify-center pb-8 sm:py-20 sm:max-w-full sm:h-screen overflow-hidden">
