	...
	return (
		<thead className="uppercase">
			<tr className="text-center">
				...
				<th className={"py-6 bg-green-500 text-green-100 px-1 whitespace-nowrap"}>Transaction's Amount</th>
				<th className={"py-6 bg-green-500 text-green-100 px-1 whitespace-nowrap"}>Date Time</th>
			</tr>
		</thead>
	);
};
