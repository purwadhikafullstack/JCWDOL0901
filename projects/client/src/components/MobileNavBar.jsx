...
const MobileNavButton = ({ active, name, to }) => {
	...
	const className = active
		? "material-icons-outlined w-full text-green-500"
		: "material-icons-outlined w-full";
...
const MobileNavBar = () => {
	...
	return (
		<div
			tabIndex="-1"
			className="fixed bottom-0 mx-auto z-50 w-[480px] inset-x-0 rounded-full sm:hidden"
		>
